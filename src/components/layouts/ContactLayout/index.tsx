...
const ContactLayout = () => {
  ...
  useEffect(() => {
    scrollRefs.current["contact"] =
      document.getElementById("contact") || undefined;
  }, [scrollRefs]);
  ...
  const { handleFormSubmition, loading, serverError } = useContactContext();
  ...
  return (
    <section
      ref={contactRef}
      className="w-full mb-16 mt-16 px-4 md:px-8 py-4"
      id="contact"
    >
