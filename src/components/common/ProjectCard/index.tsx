  ...
  return (
    <Link to={`/pages/projects/${project.slug}`}>
      <LazyLoadImage
        ...
        alt={project.title}
        className="h-[225px] w-full object-scale-down rounded-lg"
      ...
      <div className="px-4 py-8">
        <h3 className="text-2xl truncate text-gray-50 font-medium pb-2">
          {project.title}
        </h3>
        <p className="truncate text-gray-500">{project.description}</p>
      </div>
      <div
        onClick={(e) => {
          e.preventDefault();
